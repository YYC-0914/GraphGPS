...
# run_repeats ${DATASET} VGN_LapPE+GIMask+RWSE "name_tag 5x5_with_dim_96_newEnv.1run"
...
# run_repeats ${DATASET} GINE_LapPE+RWSE "name_tag gine.1run"
# run_repeats ${DATASET} VGN_LapPE+RWMask+RWSE "name_tag LapPE+RWSEMask+RWSE_Linear_5x3.1run"


# cfg_dir="configs/VGN_v2"

# DATASET="zinc"
# slurm_directive="--time=0-15:00:00 --mem=16G --gres=gpu:1 --cpus-per-task=4 -p AI4Phys"
# run_repeats ${DATASET} VGN "name_tag pos_enc_LapPE+RWSE_4x4_hidden_dim_120.1run"

# run_repeats ${DATASET} VGN-v2_LapPE+RWMask+RWSE "name_tag LapPE+VGNEMask+RWSE.1run"
