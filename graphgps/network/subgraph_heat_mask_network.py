...
from graphgps.layer.subgraph_heat_mask_block import SubgraphHeatConvBlock
...
@register_network('HSMNModel')
class HSMNModel(torch.nn.Module):
    def __init__(self, dim_in, dim_out):
        ...
        for layer in range(cfg.gnn.layers_block):
            if layer == 0:
                layers.append(SubgraphHeatConvBlock(
                    dim_in=dim_in,
                    dim_out=hidden_dim,
